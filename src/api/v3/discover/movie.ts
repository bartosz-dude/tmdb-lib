...
export function TMDBDiscoverMovie(request: Request, fetcher: Fetcher): Promise<Response>
export function TMDBDiscoverMovie(request: Request, readAccessToken: string): Promise<Response>

export default function TMDBDiscoverMovie(request: Request, fetcherOrApi: Fetcher | string): Promise<Response> {
